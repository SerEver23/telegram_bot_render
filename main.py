...
MUST_ANSWER_KEYWORDS = [
    # Русский
    "скажите", "ищу", "как", "кто знает", "кто занимается", "подскажите", "кто может", "знает",
    # Украинский
    "скажіть", "шукаю", "як", "хто знає", "хто займається", "підкажіть", "підказати", "хто може", "знає",
    # Английский
    "tell me", "looking for", "how", "who knows", "who does", "who handles", "can you tell me", "who can", "knows"
]
